                ...
                <div className="container-fluid container-service py-5">
                    <div className="container pt-5">
                        <div className="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: 600 }}>
                            ...
                            <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus augue, iaculis id elit eget, ultrices pulvinar tortor.</p>
                        </div>
                        <div className="row g-4">
                            <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div className="service-item">
                                    ...
                                    <p className="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus augue.</p>
                        ...
                        <div className="row g-5 align-items-center mb-5">
                            ...
                            <div className="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                                ...
                                <div className="d-flex">
                                    <a className="btn btn-lg-square btn-primary me-2" href><i className="fab fa-facebook-f" /></a>
                                    <a className="btn btn-lg-square btn-primary me-2" href><i className="fab fa-twitter" /></a>
                                    <a className="btn btn-lg-square btn-primary me-2" href><i className="fab fa-linkedin-in" /></a>
                                    <a className="btn btn-lg-square btn-primary me-2" href><i className="fab fa-youtube" /></a>
                                </div>
                            </div>
                        </div>
                        <div className="row g-4">
                                ...
                                <div className="team-item">
                                    <div className="position-relative overflow-hidden">
                                        ...
                                        <div className="team-social">
                                            <a className="btn btn-square btn-light mx-1" href><i className="fab fa-facebook-f" /></a>
                                            <a className="btn btn-square btn-light mx-1" href><i className="fab fa-twitter" /></a>
                                            <a className="btn btn-square btn-light mx-1" href><i className="fab fa-linkedin-in" /></a>
                                            <a className="btn btn-square btn-light mx-1" href><i className="fab fa-youtube" /></a>
                                        </div>
                                    </div>
                    ...
                    <div className="container pt-5">
                        <div className="row gy-5 gx-0">
                            <div className="col-lg-6 pe-lg-5 wow fadeIn" data-wow-delay="0.3s">
                                <h1 className="display-6 text-white mb-4">What Clients Say About Our Lab Services!</h1>
                                <p className="text-white mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus augue, iaculis id elit eget, ultrices pulvinar tortor.</p>
                                <a href className="btn btn-primary py-3 px-5">More Testimonials</a>
                            </div>
                                ...
                                <div className="bg-white p-5">
                                    <div className="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">
                                        <div className="testimonial-item">
                                            ...
                                            <p className="fs-5 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus augue, iaculis id elit eget, ultrices pulvinar tortor. Quisque vel lorem porttitor, malesuada arcu quis, fringilla risus. Pellentesque eu consequat augue.</p>
                                            <div className="d-flex align-items-center">
                                                <img className="flex-shrink-0" src="img/testimonial-1.jpg" alt />
                                                <div className="ps-3">
                                        ...
                                        <div className="testimonial-item">
                                            ...
                                            <p className="fs-5 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus augue, iaculis id elit eget, ultrices pulvinar tortor. Quisque vel lorem porttitor, malesuada arcu quis, fringilla risus. Pellentesque eu consequat augue.</p>
                                            <div className="d-flex align-items-center">
                                                <img className="flex-shrink-0" src="img/testimonial-2.jpg" alt />
                                                <div className="ps-3">
                                                    <h5 className="mb-1">Client Name</h5>
                                                    <span className="text-primary">Profession</span>
                                                </div>
